...
public class Moore extends GrainGrowth {

    public Moore(Board board, int seedAmount, int simulationStep) {
...
//        System.out.println("Third rule - Most frequent furtherNeighbor neighbourhood: " + furtherNeighbor.get(mostFrequentValue));
    ...
    private boolean fourthRule(final int currentXPosition, final int currentYPosition){
        ...
        int amountOfNeighbor = -1;
        try {
            amountOfNeighbor = neighborhood.get(mostFrequentNeighbor);
        }
        catch (Exception e){
            return false;
        }
